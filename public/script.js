document.addEventListener("DOMContentLoaded", function () {
    ...
    loginForm.addEventListener("submit", async function (event) {
        ...
        try {
            ...
            console.log("Raw API Response (JWT Token):", token);
            
            if (response.ok && token && token.includes(".")) { // Ensure it's a valid JWT
                localStorage.setItem("jwtToken", token.trim()); // Store JWT in localStorage
